...
public class CommentController {
    ...
    public ResponseEntity<CommentDto> getComment(@PathVariable(value = "postId") int postId, @PathVariable(value = "commentId") int commentId){
    ...
    public CommentDto updateComment(@PathVariable(value = "postId") long postId, @PathVariable(value="commentId") Long commentId, @RequestBody CommentDto comment){
    ...
    public ResponseEntity<CommentDto> deleteComment(@PathVariable(value = "postId") long postId, @PathVariable(value="commentId") Long commentId) {
